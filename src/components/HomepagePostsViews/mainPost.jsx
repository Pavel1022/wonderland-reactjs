            ...
            <React.Fragment>
                ...
                <div className="col-md-12">
                    <div className="blog-entry ftco-animate d-md-flex fadeInUp ftco-animated">
                        <a className="img img-2" aria-disabled="true" style={{ backgroundImage: `url(${this.props.post.image})` }}></a>
                        <div className="text text-2 pl-md-4">
                            ...
                            <div className="meta-wrap">
                                <p className="meta">
                                    ...
                                    <span><i className="icon-calendar mr-2"></i>{'Comments: ' + this.props.commentObj[`${this.props.post.id}`]}</span>
                                </p>
                            </div>
