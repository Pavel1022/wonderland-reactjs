        ...
        return (
            <React.Fragment>
                <div className="block-21 mb-4 d-flex">
                    <a href={'/post/view/' + this.props.post.id} className="blog-img mr-4" style={{ backgroundImage: `url(http://localhost:3100/public/post/${this.props.post.image}.jpg)` }}></a>
                    <div className="text">
                        ...
                        <div className="meta">
                            ...
                            <div><a><i className="icon-calendar"></i>/ Comments: {this.props.commentObj[`${this.props.post.id}`] !== undefined ? this.props.commentObj[`${this.props.post.id}`] : '0'}</a></div>
                        </div>
                    </div>
                </div>
            </React.Fragment>
